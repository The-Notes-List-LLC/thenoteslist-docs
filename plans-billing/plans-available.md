---
description: >-
  Find the plan for The Notes List that works best for you. Authoring notes is
  paid but viewing or checking off notes is always free. Subscribe to author
  shows or buy a single show.
icon: right-left
---

# Plans Available

You can access your plan from the homepage at any time. All subscriptions come with a hassle-free 15 day trial.
...
* **Viewer** (Any user can view The Notes List without a subscription.)
...
<figure><img src="../.gitbook/assets/Screenshot 2026-07-20 at 2.15.55 PM.png" alt=""><figcaption></figcaption></figure>

{% hint style="info" %}
NOTE: Additional seats can be added to Institutional licenses at the cost of $34.99/seat per year.
{% endhint %}

{% hint style="warning" %}
NOTE: To upgrade an exisitng production to a Show Pass, you must be the existing administrator for the production.
{% endhint %}
...
Navigate to **Homepage → Billing → "Manage Billing" OR "View Plans"**.
{% endstep %}

{% step %}
#### Select a new plan

Select the plan you are wanting to subscribe to or buy a single show pass.
{% endstep %}

{% step %}
#### Confirm payment

Follow payment steps and begin your subscription with a hassle-free 15 day trial.&#x20;
{% endstep %}
{% endstepper %}
...
To cancel your subscription, go to **Homepage → Billing.**
